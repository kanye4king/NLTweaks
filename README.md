...
7. Hotkey Timer Overlay (Supports animated and static accent colours from main NL App)
...
8. Can be launched either before or after opening D2 without triggering BattlEye
   
9. Comes with an infinite trial period license (All Features)
